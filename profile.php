...
<section class="tabs">
  ...
  <section class="tab-content">
    ...
    <section class="active">
      ...
      <div class="container">
          <div class="row">
              <?php $sql=mysqli_query($con,"select * from profile where username ='".$_SESSION['username']."'");
while($data=mysqli_fetch_array($sql)){
    ?>
            <div class="col-md-6">
              <label>Roll No.</label>
              <input type="text" name="username" class="form-control" value="<?php echo htmlentities($data['username']);?>" placeholder="Roll No." required readonly>
            </div>

            <div class="col-md-6">
              <label>Last Name</label>
              <input type="text" name="userlname" class="form-control" value="<?php echo htmlentities($data['userlname']);?>" placeholder="Last Name" required>
            </div>

            <div class="col-md-6 my-2">
              <label>Date Of Birth</label>
              <input type="date" name="userdob" value="<?php echo htmlentities($data['userdob']);?>" class="form-control" placeholder="Date Of Birth" required>
            </div>

            <div class="col-md-6 my-2">
              <label>Gender</label>
              <select class="form-control" value="<?php echo htmlentities($data['usergender']);?>" name="usergender" required>
                <option>Male</option>
            ...
            <div class="col-md-6 my-2">
              <label>Year</label>
              <input type="number" name="useryear" value="<?php echo htmlentities($data['useryear']);?>" class="form-control" placeholder="Year" required>
            </div>

            <div class="col-md-6 my-2">
              <label>Branch</label>
              <input type="text" name="userbranch" class="form-control" value="<?php echo htmlentities($data['userbranch']);?>" placeholder="Branch" required>
            </div>

           
            <div class="col-md-6 my-2">
              <label>Linkdin</label>
              <input type="text" name="userlinkd" value="<?php echo htmlentities($data['userlinkd']);?>" class="form-control" placeholder="https://example.com/users/">
            </div>

            <div class="col-md-6 my-2">
              <label>Github</label>
              <input type="text" name="usergithub" value="<?php echo htmlentities($data['usergithub']);?>" class="form-control" placeholder="https://example.com/users/">
            </div>

             <div class="col-md-6 my-2">
              <label>Mobile No</label>
              <input type="number" name="usermobile" class="form-control" value="<?php echo htmlentities($data['usermobile']);?>" placeholder="Mobile No">
            </div>

            <div class="col-md-6 my-2">
              <label>Instagram</label>
              <input type="text" name="userinsta" value="<?php echo htmlentities($data['userinsta']);?>" class="form-control" placeholder="https://example.com/users/">
            </div>
            ...
            <div class="col-md-12 my-2">
              ...
              <textarea name="userinfo" class="form-control" value="<?php echo htmlentities($data['userinfo']);?>" aria-label="With textarea" rows="6" required></textarea>
            </div>
     ...
     <p class="my-2">WE ARE VERY EXCITED TO KNOW ABOUT WHAT YOU ARE GOOD AT . KNOWLEDGE GET MORE EFFECTIVE WHEN IT IS SHARED AMONG OTHERS. 
        ...
        <div class="form-group">  
          ...
          <div class="form-group mb-0">
										<label>Skills </label>
										<input class="input-tags form-control" type="text" data-role="tagsinput" placeholder="Enter Specialization" name="skills" value="<?php echo htmlentities($data['skills']);?>" id="specialist">
